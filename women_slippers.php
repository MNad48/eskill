...
<div class="content">
	...
	<div class="content-top">
		...
		<div class="gclass">
<?php
	$get_slippers = "select * from products where cat_id='9'";
	$run_slippers = mysqli_query($con,$get_slippers) or die(mysqli_error($con));
	while($row=mysqli_fetch_array($run_slippers)){
		$pid=$row['p_id'];
		$pcat=$row['cat_id'];
		$pname=$row['p_name'];
		$psize=$row['p_size'];
		...
		<div class='igclass'>
				...
				<a href='women_slippers.php?add_cart=$pid'><button type='submit' Style='color:orange' name='add_cart' value='$pid' >Add to Cart</button></a>
