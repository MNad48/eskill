...
<div class="content">
	...
	<div class="content-top">
		...
		<div class="gclass">
<?php
	$get_sandals = "select * from products where cat_id='20'";
	...
	while($row=mysqli_fetch_array($run_sandals)){
		...
		<div class='iigclass'>
			<img src='admin_area/simage/$pimage'/ width='200px' height='195px'/>
				...
				<a href='kids_sandals.php?add_cart=$pid'><button type='submit' Style='color:orange' name='add_cart' value='$pid' >Add to Cart</button></a>
