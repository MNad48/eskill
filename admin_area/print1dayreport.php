...
<?php
	...
	if(isset($_GET['DT'])){
		...
		$i=0;
		$tot=0;
		echo "<h1 style='text-align:center; color:red;'> Stylo Shoes </h1>";
		echo "<table align='center' border='1px' width='996px' bgcolor='white'  >
		<tr align='center'  > <td colspan='6'> <h1> Sale's Report of $dat </h1> </td> </tr>
