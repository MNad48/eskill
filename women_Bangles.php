...
<div class="content">
	...
	<div class="content-top">
		...
		<div class="gclass">
<?php
	$get_bangs = "select * from products where cat_id='5'";
	$run_bangs = mysqli_query($con,$get_bangs) or die(mysqli_error($con));
	while($row=mysqli_fetch_array($run_bangs)){
		$pid=$row['p_id'];
		$pcat=$row['cat_id'];
		$pname=$row['p_name'];
		$psize=$row['p_size'];
		...
		echo "
			...
			<div class='igclass'>
				...
				<a href='women_bags.php?add_cart=$pid'><button type='submit'   Style='color:orange' name='add_cart' value='$pid' >Add to Cart</button></a>
