...
<div class="content">
	...
	<div class="content-top">
		...
		<div class="gclass">
<?php
	$get_socks = "select * from products where cat_id='22'";
	$run_socks = mysqli_query($con,$get_socks) or die(mysqli_error($con));
	while($row=mysqli_fetch_array($run_socks)){
		$pid=$row['p_id'];
		$pcat=$row['cat_id'];
		$pname=$row['p_name'];
		$psize=$row['p_size'];
		...
		<div class='iigclass'>
			<img src='admin_area/simage/$pimage'/ width='200px' height='195px'/>
				...
				<a href='kids_socks.php?add_cart=$pid'><button type='submit'  Style='color:orange' name='add_cart' value='$pid' >Add to Cart</button></a>
