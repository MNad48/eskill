...
<div class="content">
	...
	<div class="content-top">
		...
		<div class="gclass">
<?php
	$get_shirts = "select * from products where cat_id='10'";
	...
	while($row=mysqli_fetch_array($run_shirts)){
		...
		<div class='igclass'>
				...
				<a href='women_shirts.php?add_cart=$pid'><button type='submit'  Style='color:orange' name='add_cart' value='$pid' >Add to Cart</button></a>
